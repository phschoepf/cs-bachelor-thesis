...
parser.add_argument(
    ...
    default=["../../DoorGym/clmetrics/series4_config.yml",
             "../../DoorGym/clmetrics/series4_config_31415.yml",
             "../../DoorGym/clmetrics/series4_config_27182.yml"]
)
