...
parser.add_argument(
    ...
    default=["../../DoorGym/clmetrics/series9_config.yml",
             "../../DoorGym/clmetrics/series9_config_31415.yml",
             "../../DoorGym/clmetrics/series9_config_27182.yml"]
)
...
ax.title.set_text(f"HN-PPO+fc, no regularization")
